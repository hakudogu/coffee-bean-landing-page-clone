...
export class OurStory extends Component {
  render() {
    return (
      <div className=' w-full  md:h-full justify-center items-center relative flex flex-col'>
        <img className='object-cover h-96 md:h-full md:w-full' src='https://www.coffeebean.com.ph/wp-content/uploads/2018/07/our_story_bg_1.jpg' alt='hot black coffee'/>
